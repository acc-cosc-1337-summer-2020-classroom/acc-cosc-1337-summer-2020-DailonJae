...
int main() 
{
	...
	//loop for user to enter letter grade , credit hours then choose to continue or not do
	{
	...
	// calculation and display of GPA after the entry of grades and credit hours has finished
